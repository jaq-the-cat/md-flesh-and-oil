...
export const prefabs: { [type: string]: (Container | Item)[] } = {
  ...
  Ammo: Object.values(weapons.Ranged).map((weapon) => weapon.getAmmoItem()!),
  Healing: [
    new Healing("Bandage", 0.05, Rarity.Rare, "Humans", "20 HP", null, null),
    new Healing(
      "First Aid Kit",
      0.5,
      Rarity.VeryRare,
      "Humans",
      "50 HP",
      "Medicine check, difficulty is missing HP",
      null,
    ),
    new Healing("MedKit", 1, Rarity.VeryRare, "Humans", "75 HP", "Yes", "Medicine Proficiency"),
    new Healing("Surgical Kit", 2, Rarity.SuperRare, "Humans", "100 HP", "Yes", "Medicine Expertise"),

    new Healing("Basic Repair Kit", 2, Rarity.VeryRare, "Drones", "20 HP", null, null),
    new Healing(
      "Repair Kit",
      2,
      Rarity.SuperRare,
      "Drones",
      "50 HP",
      "Mechanics check, difficulty is missing HP",
      null,
    ),
    new Healing("JCJ Sp. WD Repair Kit", 3, Rarity.UltraRare, "Drones", "75 HP", "Yes", "Mechanics Proficiency"),

    new Healing("Solver Nanite Paste", null, Rarity.Waow, "Both", "100% HP + 5 HP for 5 turns", "Yes", null),
  ],
  Oil: [
